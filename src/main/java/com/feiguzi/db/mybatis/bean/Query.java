package com.feiguzi.db.mybatis.bean;
...
//        MYSQL_SPECIAL_STR.put("z" , "/z");
    ...
    Map<String, List<Integer>> inArrayParams = new HashMap<String, List<Integer>>();
     ...
     * 添加in查询
     */
    public Query addIn(String field, List<Integer> list) {
     ...
     * 添加in查询
     */
    public Query addInUseString(String field, String... list) {
        ...
        this.inArrayParams.put(field, intList);
        return this;
    }
     ...
     */
    public Query addIn(String field, Integer... objects) {
    ...
    public Query addBetween(String fieldName, Long begin, Long end) {
        ...
        if (begin != null && end == null) {
            gtParams.put(fieldName, begin - 1);
        } else if (end != null && begin == null) {
            ltParams.put(fieldName, end + 1 );
        } else {
            if (begin > end) {
                return this;
            }
     ...
     * @param end
     */
    public Query addBetween(String fieldName, Integer begin, Integer end) {
        if (begin == null && end == null) {
            return this;
        }
    ...
    public Query addBetween(String fieldName, Date begin, Date end) {
        if (begin == null && end == null) {
            return this;
        }

        if (begin != null && end == null) {
            gtParams.put(fieldName, begin);
        } else if (end != null && begin == null) {
            ltParams.put(fieldName, end);
        } else {
            if (begin.after(end)) {
                return this;
            }
     ...
     * @return
     */
    public static String filterSpecialAddLike(String str) {
     ...
     * @return
     */
    public Query addIncludeField(String... fieldNames) {
        for (String field : fieldNames){
            this.includeField.add(field);
        }
        return this;
    }
    ...
    public Map<String, List<Integer>> getInArrayParams() {
